...
describe('Linter - code-complexity', () => {
  it('should raise error when cyclomatic complexity of a function is too high', () => {
    const report = linter.processStr(
      funcWithV7V8Header(require('../../fixtures/best-practises/code-complexity-high')),
      {
...
describe('Linter - code-complexity - V7 V8 additions', () => {
  it('should raise error when cyclomatic complexity of a function is too high', () => {
    const report = linter.processStr(
      funcWithV7V8Header(require('../../fixtures/best-practises/code-complexity-high')),
      {
  ...
  it('should not raise error when cyclomatic complexity of a function is equal to max default allowed', () => {
    const report = linter.processStr(
      funcWithV7V8Header(require('../../fixtures/best-practises/code-complexity-low')),
      {
        rules: { 'code-complexity': 'error' },
      }
    )
  ...
  it('should raise error when cyclomatic complexity of a modifier is too high', () => {
    const report = linter.processStr(
      modifierWithV7V8Header(require('../../fixtures/best-practises/code-complexity-high')),
      {
        rules: { 'code-complexity': 'error' },
      }
    )
  ...
  const CUSTOM_CONFIG_CHECK_CODE = funcWithV7V8Header(
    multiLine(
      ' if (a > b) {                   ',
      '   if (b > c) {                 ',
      '     if (c > d) {               ',

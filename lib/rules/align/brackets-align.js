...
class BracketsAlign extends BaseChecker {
    ...
    validateBlock(ctx) {
        ...
        if (!bracket.isCorrectAligned()) {
            this._error(bracket.ctx, bracket.alignErrorMsg);
        }
    }
...
class Block {
    ...
    openBracket () {
        ...
        return (this.isFunctionDefinition()) ? new FunctionOpenBracket(bracketCtx) : new UsualOpenBracket(bracketCtx);
    }
...
class OpenBracket {
    ...
    constructor (ctx) {
        this.ctx = ctx;
        this.alignErrorMsg = 'Open bracket must be indented by other constructions by space';
    }
...
class UsualOpenBracket extends OpenBracket {
    ...
    constructor (ctx) {
        super(ctx);
        this.alignErrorMsg = 'Open bracket must be on same line. It must be indented by other constructions by space';
    }

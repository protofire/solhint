...
const DEFAULT_IMMUTABLE_AS_CONSTANTS = true
const DEFAULT_SEVERITY = 'warn'
const DEFAULT_OPTION = { immutablesAsConstants: DEFAULT_IMMUTABLE_AS_CONSTANTS }
const ERR_DESCRIPTION =
  'When True, immutable variables are expected to be in capitalized SNAKE_CASE. Otherwise mixedCase is expected.'
...
const meta = {
  ...
  schema: {
    type: 'object',
    required: ['immutablesAsConstants'],
    properties: {
  ...
  constructor(reporter, config) {
    ...
    this.treatImmutablesAsConstants =
      ...
      config.getObjectPropertyBoolean(
        ruleId,
        'immutablesAsConstants',
        DEFAULT_IMMUTABLE_AS_CONSTANTS
      )
  }

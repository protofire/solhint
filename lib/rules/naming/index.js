...
const ContractNamePascalCaseChecker = require('./contract-name-pascalcase')
const EventNamePascalCaseChecker = require('./event-name-pascalcase')
...
module.exports = function checkers(reporter, config) {
  return [
    ...
    new ContractNamePascalCaseChecker(reporter),
    new EventNamePascalCaseChecker(reporter),

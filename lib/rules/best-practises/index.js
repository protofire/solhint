...
const RevertCustomOverRequireChecker = require('./revert-custom-over-require')
const StrictOverrideInterface = require('./strict-override')
const StrictImportInterface = require('./strict-imports')
...
module.exports = function checkers(reporter, config, inputSrc) {
  return [
    ...
    new RevertCustomOverRequireChecker(reporter),
    new StrictOverrideInterface(reporter),
    new StrictImportInterface(reporter),
  ]
}

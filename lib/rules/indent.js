...
class IndentChecker {
    ...
    constructor(reporter, config) {
        ...
        this.blockValidator = new BlockValidator(this.indent, reporter);
        this.nestedSingleLineValidator = new NestedSingleLineValidator(this.indent, reporter);
        this.baseIndentMultiplicityValidator = new BaseIndentMultiplicityValidator(this.indent, reporter);
    }
...
class KnowLineValidator {
    ...
    makeReportCorrectLine(line, col, correctIndent) {
        ...
        this.reporter.addMessageExplicitLine(
            ...
            `Expected indentation of ${correctIndent} spaces but found ${col}`, 'indent'
        );
    }
...
class BlockValidator extends KnowLineValidator {
    ...
    validateIndentOfNestedElements(block) {
        ...
        block.forEachNestedNode((curItem, curLine, curColumn) => {

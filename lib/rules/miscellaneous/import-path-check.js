  ...
  resolveImportPath(importPath) {
    ...
    if (path.isAbsolute(importPath)) {
      if (fs.existsSync(importPath)) {
        console.log('object path is absolute')
        return importPath
      }
    } else {
      console.log('object path is relative')
      ...
      if (fs.existsSync(resolvedRelativePath)) {
        console.log('object path is relative and exists')
    ...
    for (const searchOn of this.searchOn) {
      console.log('object path is in searchOn')
      ...
      if (fs.existsSync(candidatePath)) {
        console.log('object path is in searchOn and exists')
        return candidatePath
      }
    }

    console.log('object path not exists')

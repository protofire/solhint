...
/*
  ...
  - If searchOn has values are concatenated with DEFAULT_LOCATIONS
  - If extends:recommended and rule is overwritten with an empty searchOn, values are concatenated with DEFAULT_LOCATIONS
  - Test fails when there's extends: 'solhint:all/recommended', and rule is ALSO specified with an empty searchOn: SOLVED
*/
